...
public class Bulk_GRNpage {
	...
	@FindBy(xpath="//button[normalize-space()='Upload Bulk Grn']")
	public WebElement Upload_BulkGRN;
	
	@FindBy(xpath = "//input[@id='grnfiles-xl_file']")
	public WebElement Browse_file;
	
	@FindBy(xpath = "//button[@type='submit']")
	public WebElement Submit_BulkGRN;
	
	@FindBy(xpath = "//div[@id='w2']")
