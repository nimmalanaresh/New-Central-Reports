...
@Test(priority=1)
	public void Bulk_GRN_Page() throws Throwable {
	 ...
	 prop.load(fis);
	    ...
	    if(actual.contains("Bulk")) {
	    	System.out.println("bulk grn page opened");
	    }
	    else {
	    	System.out.println("bulk grn page not opened");
	    }
}

@Test(priority=2)
public void Bulk_GRN_Details() throws Throwable {
